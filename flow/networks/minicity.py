...
class MiniCityNetwork(Network):
    ...
    def specify_nodes(self, net_params):
        ...
        for node in nodes:
            self.nodes_dict[node["id"]] = np.array(
                [node["x"] * SCALING, node["y"] * SCALING]
            )
        ...
        edges = [
            ...
            },
            {
                ...
                "shape": [
                    (0.90 + 0.53 * cos(t), 0.93 + 0.53 * sin(t))
                    for t in linspace(
                        3 * pi / 2 + 1.16 / 0.53, 3 * pi / 2 + 1.46 / 0.53, res
                    )
                ],
            },
            {
            ...
            },
            {
                ...
                "type": "edgeType",
                "shape": [
                    (1.19 + 0.54 * cos(t), 5.21 + 0.54 * sin(t))
            ...
            },
            {
                ...
                "type": "edgeType",
                "shape": [
                    (1.11 + 0.46 * cos(t), 3.61 + 0.46 * sin(t))
            ...
            },
            {
                ...
                "type": "edgeType",
                "shape": [
                    (1.21 + 0.46 * cos(t), 4.53 + 0.46 * sin(t))
            ...
            },
            {
                ...
                "type": "edgeType",
                "shape": [
                    (1.89 + 0.54 * cos(t), 0.94 + 0.54 * sin(t))
            ...
            },
            {
                ...
                "type": "edgeType",
                "shape": [
                    (2.13 + 0.46 * cos(t), 4.44 + 0.46 * sin(t))
                    for t in reversed(linspace(pi / 2, pi, res))
                ],
            },
            {
            ...
            },
            {
                ...
                "type": "edgeType",
                "shape": [
                    (1.88 + 0.46 * cos(t), 2.29 + 0.46 * sin(t))
            ...
            },
            {
                ...
                "type": "edgeType",
                "shape": [
                    (1.88 + 0.46 * cos(t), 0.86 + 0.46 * sin(t))
            ...
            },
            {
                ...
                "type": "edgeType",
                "shape": [
                    (2.59 + 0.46 * cos(t), 0.86 + 0.46 * sin(t))
                    for t in reversed(linspace(3 * pi / 2, 2 * pi, res))
                ],
            },
            {
            ...
            },
            {
                ...
                "type": "edgeType",
                "shape": [
                    (3.51 + 0.46 * cos(t), 0.86 + 0.46 * sin(t))
            ...
            },
            {
                ...
                "type": "edgeType",
                "shape": [
                    (3.95 + 3.84 * cos(t), 4.39 + 3.84 * sin(t) - 0.15)
                    for t in linspace(
                        3 * pi / 2 - 0.1 / 3.84, 3 * pi / 2 + 1.3 / 3.84, res
                    )
                ],
            },
            {
            ...
            },
            {
                ...
                "type": "edgeType",
                "shape": [
                    (4.75 - 0.54 * cos(t), 4.29 - 0.54 * sin(t))
            ...
            },
            {
                ...
                "type": "edgeType",
                "shape": [
                    (4.75 - 0.54 * sin(t), 4.29 - 0.54 * cos(t))
                    for t in linspace(0, pi / 2, res)
                ],
            },
            {
                ...
                "type": "edgeType",
                "shape": [
                    (3.95 + 0.63 * cos(t), 1.03 + 0.63 * sin(t))
                    for t in reversed(linspace(3 * pi / 2, 2 * pi, res))
                ],
            },
            {
            ...
            },
            {
                ...
                "shape": [
                    (5.08 + 0.58 * cos(t), 1.17 + 0.58 * sin(t))
                    for t in linspace(
                        1.2 * pi + 2.58 / 0.58, 1.66 * pi + 2.58 / 0.58, res
                    )
                ],
            },
            {
            ...
            },
            {
                ...
                "type": "edgeType",
                "shape": [
                    (5.08 + 0.54 * cos(t), 4.29 + 0.54 * sin(t))
            ...
            },
            {
                ...
                "type": "edgeType",
                "shape": [
                    (5.08 - 0.54 * cos(t), 5.21 + 0.54 * sin(t))
                    for t in linspace(pi / 2, pi, res)
                ],
            },
            {
            ...
            },
            {
                ...
                "shape": [
                    (0.90 + 0.53 * cos(t), 0.93 + 0.53 * sin(t))
                    for t in linspace(
                        3 * pi / 2 + 1.46 / 0.53, 3.46 * pi / 2 + 1.46 / 0.53, res
                    )
                ],
            },
            {
        ...
        for edge in edges:
            if "shape" in edge:
                edge["length"] = sum(
                    [
                        np.sqrt(
                            (edge["shape"][i][0] - edge["shape"][i + 1][0]) ** 2
                ...
                edge["shape"] = [(x * SCALING, y * SCALING) for x, y in edge["shape"]]
            else:
                edge["length"] = np.linalg.norm(
                    self.nodes_dict[edge["to"]] - self.nodes_dict[edge["from"]]
                )
    ...
    def specify_connections(self, net_params):
        ...
        for r_from, r_to in zip(edges_from_r, edges_to_r):
            for i in range(num_lanes):
                conn += [{"from": r_from, "to": r_to, "fromLane": i, "toLane": i}]

        # split one lane to two lanes from e_68 to e_66
        conn += [{"from": "e_68", "to": "e_66", "fromLane": 0, "toLane": 0}]
        ...
        for u_from, u_to in zip(edges_from_u, edges_to_u):
            for i in range(num_lanes):
                conn += [{"from": u_from, "to": u_to, "fromLane": i, "toLane": i}]
