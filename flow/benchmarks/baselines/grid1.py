...
def grid1_baseline(num_runs, render=True):
    ...
    phases = [
        {"duration": "31", "minDur": "5", "maxDur": "45", "state": "GrGr"},
        {"duration": "2", "minDur": "2", "maxDur": "2", "state": "yryr"},
        {"duration": "31", "minDur": "5", "maxDur": "45", "state": "rGrG"},
        {"duration": "2", "minDur": "2", "maxDur": "2", "state": "ryry"},
    ]
