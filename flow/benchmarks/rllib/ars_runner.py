...
# required input parameters
parser.add_argument("--upload_dir", type=str, help="S3 Bucket to upload to.")

# optional input parameters
parser.add_argument(
    "--num_rollouts", type=int, default=50, help="The number of rollouts to train over."
)

# optional input parameters
parser.add_argument(
    "--num_cpus", type=int, default=2, help="The number of rollouts to average over."
)
