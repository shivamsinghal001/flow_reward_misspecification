...
class MultiTrafficLightGridPOEnv(TrafficLightGridPOEnv, MultiEnv):
    ...
    def get_state(self):
        ...
        for _, edges in self.network.node_mapping:
            ...
            for edge in edges:
                ...
                local_dists_to_intersec.extend(
                    [
                        (
        ...
        for rl_id in self.k.traffic_light.get_ids():
            ...
            local_edge_numbers = [
                self.k.network.get_edge_list().index(e) for e in local_edges
            ]
            local_id_nums = [
                rl_id_num,
                self._get_relative_node(rl_id, "top"),
    ...
    def compute_reward(self, rl_actions, **kwargs):
        ...
        if self.env_params.evaluate:
            ...
            rew = -rewards.min_delay_unscaled(self) + rewards.penalize_standstill(
                self, gain=0.2
            )
