...
@deprecated(
    "flow.envs.green_wave_env", "flow.envs.traffic_light_grid.TrafficLightGridEnv"
)
...
@deprecated(
    "flow.envs.green_wave_env", "flow.envs.traffic_light_grid.TrafficLightGridPOEnv"
)
...
@deprecated(
    "flow.envs.green_wave_env", "flow.envs.traffic_light_grid.TrafficLightGridTestEnv"
)
